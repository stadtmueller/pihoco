 ...
 * @param nChannelCode  Number of the switch itself (1..4)
 */
void RCSwitch::switchOn(std::string sGroup, int nChannel) {
 ...
 * @param nChannelCode  Number of the switch itself (1..4)
 */
void RCSwitch::switchOff(std::string sGroup, int nChannel) {
 ...
 */
std::string RCSwitch::getCodeWordA(std::string sGroup, int nChannelCode, boolean bStatus) {
   int nReturnPos = 0;
 ...
 */
void RCSwitch::sendTriState(std::string sCodeWord) {
