...
class RCSwitch {
  ...
  public:
    ...
    void switchOn(std::string sGroup, int nSwitchNumber);
    void switchOff(std::string sGroup, int nSwitchNumber);
  ...
  private:
    ...
    std::string getCodeWordA(std::string sGroup, int nSwitchNumber, boolean bStatus);
